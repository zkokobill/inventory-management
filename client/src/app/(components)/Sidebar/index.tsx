...
const Sidebar = () => {
    ...
    return (
        <div className={sidebarClassNames}>
            ...
            >
                <Image
                    src="https://s3-inventorymanagement-koko.s3.eu-west-3.amazonaws.com/logo.png"
                    alt="logo"
                    width={25}
                    height={25}
            ...
            <div className={`${isSidebarCollapsed ? "hidden" : "block"}mb-10`}>
                <p className='text-center text-xs text-gray-500'> &copy; {new Date().getFullYear().toString()} Max Migutin</p>
            </div>
        </div >
    )
}
